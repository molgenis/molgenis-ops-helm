...
To import the grafana node_exporter dashboard you will need to import a json file into grafana. The json file can be found in: github.com -> molgenis-ops-helm -> charts -> molgenis-grafana -> import_dashboards -> linux-node-exporter-dashboard.json
To import the dashboard, go to the grafana website and sign in with your github account. After signing in, go to Dashboards -> Manage and click on Import. Then press "Upload .json File" and select the json file. When loaded, select by k8-prometheus "k8-prometheus" and press import and you are done.
